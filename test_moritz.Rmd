...
```{r}
prism.achilles.pancan.numeric <- numeric(prism.achilles.pancan)
```

```{r pressure, echo=FALSE}
prism.achilles.pancan.numeric <- prism.achilles.pancan
for (z in 1:25) (prism.achilles.pancan.numeric[z,1:18119] <- as.numeric(prism.achilles.pancan[z,1:18119]))
```
```{r}
is.numeric(prism.achilles.pancan.numeric[1:2,2])
is.numeric(as.numeric(prism.achilles.pancan[1,1:18119]))
hist(prism.achilles.pancan.numeric[1,])
prism.achilles.pancan.numeric.mean = 
```
```{r}
