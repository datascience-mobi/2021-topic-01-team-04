...
```{r}
ef.dr.identifier(prism.clean, -6.5)
```
...
```{r}
ef.dr.identifier(pancan.clean, -6.5)
```
...
```{r}
ef.dr.identifier(PanCanSub.DucAdeexo, -6.5)
```

```{r}
ef.dr.identifier(PanCanSub.DucAdeCar, -6.5)
```

```{r}
ef.dr.identifier(PanCanSub.DucAdeCarexo, -6.5)
```

```{r}
ef.dr.identifier(PanCanSub.Som, -6.5)
```
