...
```{r}
cor.mat.achilles <- cor(prism.achilles.numeric.pancan[,1:100])
which(cor.mat.achilles > 0.85 & cor.mat.achilles < 1) 
cor.mat.achilles[which(cor.mat.achilles > 0.85 & cor.mat.achilles < 1)]
```
